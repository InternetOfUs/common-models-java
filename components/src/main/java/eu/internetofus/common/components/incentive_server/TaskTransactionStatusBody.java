...
/**
 * Represents the status of a task transaction.
 *
 * @author UDT-IA, IIIA-CSIC
 */
@Schema(hidden = true, name = "taskTransaction_status_body", description = "The status of a task transaction.")
public class TaskTransactionStatusBody extends ReflectionModel implements Model {
