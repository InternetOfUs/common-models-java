...
public class Containers extends MongoContainer<Containers> implements WeNetComponentContainers {
   ...
   */
  public static final String WENET_PROFILE_MANAGER_DOCKER_NAME = "internetofus/profile-manager:1.1.2";
   ...
   */
  public static final String WENET_INTERACTION_PROTOCOL_ENGINE_DOCKER_NAME = "internetofus/interaction-protocol-engine:1.2.0";
