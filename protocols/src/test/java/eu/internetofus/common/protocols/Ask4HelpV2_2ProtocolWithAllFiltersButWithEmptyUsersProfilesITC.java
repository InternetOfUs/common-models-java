 ...
 */
public class Ask4HelpV2_2ProtocolWithAllFiltersButWithEmptyUsersProfilesITC
  ...
  protected Task createTaskForProtocol() {
    ...
    task.attributes.put("domain", "studying_career").put("domainInterest", "similar").put("beliefsAndValues",
        "similar");
