 ...
 */
public abstract class AbstractAsk4HelpV2_2ProtocolITC extends AbstractDefaultProtocolITC {

  /**
   * {@inheritDoc}
   *
   * @return {@link DefaultProtocols#ASK_4_HELP_V2_2}
   */
  @Override
  protected DefaultProtocols getDefaultProtocolsToUse() {

    return DefaultProtocols.ASK_4_HELP_V2_2;
  }
  ...
  protected Task createTaskForProtocol() {
    ...
    taskToCreate.attributes = new JsonObject().put("domain", "varia_misc").put("domainInterest", "indifferent")
        .put("beliefsAndValues", "indifferent").put("sensitive", false).put("anonymous", false).put("maxUsers", 5);
    return taskToCreate;
