...
/**
 * Test the calculus when all domains are indifferent.
 *
 * @author UDT-IA, IIIA-CSIC
 */
public class PilotM46UCProtocolWithAllIndifferentDimensionsITC extends AbstractPilotM46UCProtocolITC {

  /**
   * {@inheritDoc} ‘academic life’
   */
  @Override
  protected String domain() {

    return Domain.ACADEMIC_LIFE.toTaskTypeDomain();
  }
